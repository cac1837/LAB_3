...
SOURCEFILES_QUOTED_IF_SPACED=LAB3.c ADC_3.c LCD.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LAB3.p1 ${OBJECTDIR}/ADC_3.p1 ${OBJECTDIR}/LCD.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/LAB3.p1.d ${OBJECTDIR}/ADC_3.p1.d ${OBJECTDIR}/LCD.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LAB3.p1 ${OBJECTDIR}/ADC_3.p1 ${OBJECTDIR}/LCD.p1

# Source Files
SOURCEFILES=LAB3.c ADC_3.c LCD.c
...
${OBJECTDIR}/ADC_3.p1: ADC_3.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ADC_3.p1.d 
	@${RM} ${OBJECTDIR}/ADC_3.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/ADC_3.p1 ADC_3.c 
	@-${MV} ${OBJECTDIR}/ADC_3.d ${OBJECTDIR}/ADC_3.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/ADC_3.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
